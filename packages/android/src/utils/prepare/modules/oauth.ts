...
import { generateWXEntryActivity, getWXEntryActivityFilePath } from '../files/WXEntryActivity.java.js'
import { appendDependencies } from '../files/app-build.gradle.js'
import { appendFeature } from '../files/dcloud_properties.xml.js'
import type { Results } from '../results.js'
import { appendMerge } from '../xml.js'

export async function appendOauth(results: Results) {
