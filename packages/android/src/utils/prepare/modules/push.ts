...
import { AndroidDir, App, Log } from '@wtto00/uniapp-common'
import { resourceSizes } from '../../const.js'
import { appendActivity, appendMetaData, appendService } from '../files/AndroidManifest.xml.js'
...
import { appendMerge, appendSet } from '../xml.js'

export async function appendPush(results: Results) {
