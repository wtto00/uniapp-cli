...
import { appendActivity, appendMetaData, appendPermissions } from '../files/AndroidManifest.xml.js'
import { generateWXPayEntryActivity, getWXPayEntryActivityFilePath } from '../files/WXPayEntryActivity.java.js'
import { appendDependencies, mergeNumberField } from '../files/app-build.gradle.js'
import { appendFeature } from '../files/dcloud_properties.xml.js'
import type { Results } from '../results.js'

export async function appendPayment(results: Results) {
