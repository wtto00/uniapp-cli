...
function mergeRecord<T extends object = MetaData>(record1?: Record<string, T>, record2?: Record<string, T>) {
...
function mergeActivity(activity1?: Record<string, Activity>, activity2?: Record<string, Activity>) {
